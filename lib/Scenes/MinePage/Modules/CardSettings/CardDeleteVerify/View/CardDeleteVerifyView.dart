...
class CardDeleteVerifyView extends StatelessWidget {
  final CardDeleteVerifyPresenter presenter;
  ...
  CardDeleteVerifyView(this.presenter);
  ...
  submitPressed(BuildContext context, String code) async {
    presenter.deletePressed(context, code);
  }
