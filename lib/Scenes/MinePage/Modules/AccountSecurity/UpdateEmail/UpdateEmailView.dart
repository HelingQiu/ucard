...
class UpdateEmailView extends StatelessWidget {
  final UpdateEmailPresenter presenter;
  ...
  final TextEditingController _oldEmailCodeController =
  ...
  UpdateEmailView(this.presenter);
  ...
  Widget _buildPhoneVerifyView(BuildContext context) {
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Pinput(
          length: length,
          controller: _oldEmailCodeController,
        ...
        child: ValueListenableBuilder<bool>(
          builder: (BuildContext context, bool value, Widget? child) {
            return SendCodeButton(1, true, true, Colors.transparent, () {
              ...
              streamController.add(0);
              hideOverView();
              sendCodePressed(context, UserInfo.shared.email);
            });
          },
        ...
        child: ValueListenableBuilder<bool>(
          builder: (BuildContext context, bool value, Widget? child) {
            return SendCodeButton(1, false, true, Colors.transparent, () {
              ...
              streamController.add(0);
              hideOverView();
              sendCodePressed(context, _newEmailController.text);
            });
          },
          valueListenable: _sendCodeSuccess,
        ));
  ...
  submitButtonPressed(BuildContext context) async {
    String _oldEmailCode = _oldEmailCodeController.text;
    String _newEmail = _newEmailController.text;
    String _newEmailCode = _emailCodeController.text;

    if (_oldEmailCode.isEmpty) {
    ...
    if (_newEmailCode.isEmpty) {
      showTopError(context, "Please enter verification code".tr());
      return;
    }

    List list = [
      {"account": _newEmail, "type": 1, "code": _newEmailCode},
      {"account": UserInfo.shared.email, "type": 1, "code": _oldEmailCode},
    ];
    presenter.ChangeEmailAction(context, list, _newEmail);
  }
