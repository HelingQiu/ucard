...
class BindPhoneView extends StatelessWidget {
  final BindPhonePresenter presenter;
        ...
        child: ValueListenableBuilder<bool>(
          builder: (BuildContext context, bool value, Widget? child) {
            return SendCodeButton(1, true, true, Colors.transparent, () {
              isSent = true;
              streamController.add(0);
              sendCodePressed(UserInfo.shared.email);
              FocusScope.of(context).unfocus();
            });
          },
  ...
  submitButtonPressed(BuildContext context) async {
    ...
    presenter.bindPhoneAction(context, list, phoneStr);
  }
  ...
  showTopError(BuildContext context, String message) {
    showDialog(
        context: context,
        builder: (_) {
          return ShowMessage(2, message.tr(), styleType: 1, width: 257);
        });
  }
}
