...
class ChangePsdVerifyView extends StatelessWidget {
  final ChangePsdVerifyPresenter presenter;
  ...
  ChangePsdVerifyView(this.presenter);
    ...
    return BlocBuilder<ThemeCubit, AppTheme>(builder: (context, theme) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            UserInfo.shared.username == UserInfo.shared.email
