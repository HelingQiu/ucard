...
class ForgetVerifyView extends StatelessWidget {
  final ForgetVerifyPresenter presenter;
  ...
  ForgetVerifyView(this.presenter);
  ...
  submitPressed(BuildContext context, String code) async {
    presenter.forgetRessetPressed(context, code);
  }
