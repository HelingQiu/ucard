...
class WithdrawVerifyView extends StatelessWidget {
  final WithdrawVerifyPresenter presenter;
  ...
  WithdrawVerifyView(this.presenter);
  ...
  submitPressed(BuildContext context, String code) async {
    presenter.withdrawPressed(context, code);
  }
